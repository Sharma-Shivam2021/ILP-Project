...
public interface NurseService {
    ...
    // Incharge: update "Allow Shift Change" permission for a nurse
    NurseResponseDto updateAllowShiftChange(Integer nurseId, Boolean allowShiftChange, String inchargeUsername);
}

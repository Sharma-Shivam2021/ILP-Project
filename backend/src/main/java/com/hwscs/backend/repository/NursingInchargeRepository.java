...
public interface NursingInchargeRepository extends JpaRepository<NursingIncharge, Integer> {
    ...
    Optional<NursingIncharge> findByEmployeeCode(String employeeCode);

    Optional<NursingIncharge> findByContactPhone(String contactPhone);

    Optional<NursingIncharge> findByContactEmail(String contactEmail);
}
